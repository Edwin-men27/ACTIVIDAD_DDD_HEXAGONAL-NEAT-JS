...
const exceptions_2 = require("../../../domain/aplicaciones/exceptions");
let DomainExceptionFilter = class DomainExceptionFilter {
        ...
        const map = new Map([
            ...
            [exceptions_2.AplicacionNotFoundException, { status: common_1.HttpStatus.NOT_FOUND, message: exception.message }],
            [exceptions_2.NombreAplicacionDuplicadoException, { status: common_1.HttpStatus.CONFLICT, message: exception.message }],
            [exceptions_2.VersionDuplicadaException, { status: common_1.HttpStatus.BAD_REQUEST, message: exception.message }],
            [exceptions_2.VersionNoValidaException, { status: common_1.HttpStatus.BAD_REQUEST, message: exception.message }],
        ]);
